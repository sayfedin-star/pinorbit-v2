-- ==============================================================================
-- Migration: 20260906000000_monotonic_comments.sql
-- Project: Project 4 (PinArchive: kuuugffvyokywtgmdrfk)
-- Description: Updates pa_ingest_pin_batch to preserve monotonic max for comments
--              (GREATEST(excluded.comments, pa_pins.comments)) matching saves/repins.
-- ==============================================================================
